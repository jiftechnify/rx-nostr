 ...
 */
export interface MessagePacket<M extends Nostr.ToClientMessage.Any = Nostr.ToClientMessage.Any> {
    from: string;
    message: M;
}
/**
 ...
 */
export type ConnectionState = "not-started" | "starting" | "ongoing" | "reconnecting" | "error" | "rejected" | "terminated";
/**
